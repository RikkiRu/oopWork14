namespace Client_2._0
{
	partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.bCreateConsultersReport = new System.Windows.Forms.Button();
			...
			this.panel9.Controls.Add(this.bCreateConsultersReport);
			...
			this.bCreateODFReport.Click += new System.EventHandler(this.bCreateODFReport_Click);
			// 
			...
			this.bShowFAQ.Text = "Стандартные вопросы";
			...
			this.datePicker.Location = new System.Drawing.Point(293, 184);
			this.datePicker.Name = "datePicker";
			this.datePicker.Size = new System.Drawing.Size(112, 26);
			this.datePicker.TabIndex = 10;
			this.datePicker.Visible = false;
			// 
			// bCreateConsultersReport
			// 
			this.bCreateConsultersReport.Location = new System.Drawing.Point(411, 185);
			this.bCreateConsultersReport.Name = "bCreateConsultersReport";
			this.bCreateConsultersReport.Size = new System.Drawing.Size(166, 23);
			this.bCreateConsultersReport.TabIndex = 11;
			this.bCreateConsultersReport.Text = "Создать отчёт";
			this.bCreateConsultersReport.UseVisualStyleBackColor = true;
			this.bCreateConsultersReport.Visible = false;
			this.bCreateConsultersReport.Click += new System.EventHandler(this.bCreateConsultersReport_Click);
			// 
			// MainForm
			// 
		...
		private System.Windows.Forms.Button bCreateConsultersReport;
